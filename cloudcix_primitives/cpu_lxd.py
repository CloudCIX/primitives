...
def update(
    ...
    # Define message
    messages = {
        1000: f'Successfully updated the CPU limit for {containers} {instance_name} on {endpoint_url}',
        ...
        3023: f'Failed to set CPU limit for {containers} {instance_name}. Error: ',
    }
    ...
    def run_host(endpoint_url, prefix, successful_payloads):
        ...
        try:
            ...
            fmt.add_successful(f'{containers}.set', {'limits.cpu': str(cpu)})
