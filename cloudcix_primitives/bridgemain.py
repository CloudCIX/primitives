...
def scrub(
    ...
    messages = {
        ...
        3124: f'Failed to connect to the local host for check_up_file payload: ',
        3125: f'Failed to run check_up_file payload on the local host. Payload exited with status ',
        3126: f'Failed to connect to the local host for delete_up_file payload: ',
        3127: f'Failed to run delete_up_file payload on the local host. Payload exited with status ',
        3128: f'Failed to connect to the local host for check_down_file payload: ',
        3129: f'Failed to run check_down_file payload on the local host. Payload exited with status ',
        3130: f'Failed to connect to the local host for delete_up_file payload: ',
        3131: f'Failed to run delete_down_file payload on the local host. Payload exited with status ',
        3132: f'Failed to connect to the local host for check_service_file payload: ',
        3133: f'Failed to run check_service_file payload on the local host. Payload exited with status ',
        3134: f'Failed to connect to the local host for delete_up_file payload: ',
        3135: f'Failed to run delete_service_file payload on the local host. Payload exited with status ',
        3136: f'Failed to connect to the local host for reload_services payload: ',
        3137: f'Failed to run reload_services payload on the local host. Payload exited with status ',
    }
