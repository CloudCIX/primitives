...
def print_usage():
    print("""
Usage: test_migrate_lxd.py update <endpoint_url> <target_cluster_member> [project] [instance_name]

Arguments:
  update                 - Command to trigger migration
